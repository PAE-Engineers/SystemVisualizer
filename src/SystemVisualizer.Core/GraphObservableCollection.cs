...
namespace SystemVisualizer.Core
{
    ...
    public class GraphObservableCollection<T> : Collection<T>, INodifyObservableCollection<T>, INotifyPropertyChanged,
        INotifyCollectionChanged
    {
        protected static readonly PropertyChangedEventArgs IndexerPropertyChanged =
        ...
        public GraphObservableCollection()
        {
        }

        public GraphObservableCollection(IEnumerable<T> collection)
